		...
		<form class="text-center border border-light p-5" method="POST" action="{{action('AdvertismentController@update', $adv->id)}}" enctype="multipart/form-data">
			...
			<div class="row">
				<div class="col">
					...
					<input type="number" name="contact"  value="{{$adv->contact}}" class="form-control mb-4" placeholder="Enter the Contact number">
				</div>
				<div class="col">
			...
			<div class="row">
				...
				<div class="col">
					<div class="form-group">
						...
						<input type="text" name="direct"  id="defaultContactFormEmail" class="form-control
						mb-4" placeholder="Add_Link" value="{{$adv->direct}}">
					</div>
				</div>
			</div>
